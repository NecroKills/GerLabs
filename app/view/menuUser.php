        ...
        <div class="modal-content">
          <form id="addreserva" class="form-horizontal">
            ...
            <div class="modal-body">
              ...
              <div class="col-sm-10">
                <input type="text" name="reserva[title]" class="form-control" id="title" placeholder="Título">
              </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
              <label for="color" class="col-sm-2 control-label">Professor</label>
              <div class="col-sm-10">
              ...
              <div class="form-group">
              <label for="start" class="col-sm-2 control-label">Dia</label>
              <div class="col-sm-10">
                <input type="text" name="reserva[start]" class="form-control" id="start" readonly>
              </div>
              </div>
              <div class="form-group">
              <label for="hrinicio" class="col-sm-2 control-label">Hora do início</label>
              <div class="col-sm-10">
                <input type="time" name="reserva[hrinicio]" class="form-control">
              </div>
              </div>
              <div class="form-group">
              <label for="hrfim" class="col-sm-2 control-label">Hora do fim</label>
              <div class="col-sm-10">
                <input type="time" name="reserva[hrfim]" class="form-control">
              </div>
              </div>
            </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <form id="editarEvento" class="form-horizontal">
            ...
            <input type="hidden" name="acao" value="editarReservaUsuario">
    			  <div class="modal-body">
    				  <div class="form-group">
    					<label for="title" class="col-sm-2 control-label">Titulo</label>
    					<div class="col-sm-10">
